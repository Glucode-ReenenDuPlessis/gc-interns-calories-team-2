...
class NutritionViewCell: UICollectionViewCell {
    ...
    var calText: UILabel = {
        var text = UILabel()
        var attributedText = NSMutableAttributedString(string: "Calories",attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 20, weight: .medium)])
...
//        }
        ...
        self.nutritionPer.text = "\(startValue)%"
        startValue += 1
